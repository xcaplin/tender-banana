...
function App() {
  ...
  // Get current tender source (always live data)
  const currentTenders = liveTenders
...
<body>
  ...
  <div class="footer">
    ...
    <p>Report Date: ${today} | Data Source: Live Data</p>
...
<body>
  <div class="dashboard">
    ...
    <div class="footer">
      <p>Generated by Sirona Tender Intelligence Dashboard</p>
      <p>Data Source: Live Data | ${today}</p>
    </div>
  </div>
</body>
</html>
    ...
    return (
      <div className="app">
        ...
        <div className="empty-data-container">
          ...
          <p>Click "Fetch Tenders" to load opportunities from UK government procurement sources.</p>
        </div>
      </div>
    )
  }
